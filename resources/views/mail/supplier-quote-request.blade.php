...
<ul>
    ...
    <li><strong>Route:</strong> {{ $service->flightRequest->originAirport->icao_code }} &rarr; {{ $service->flightRequest->destinationAirport->icao_code }}</li>
    <li><strong>Departure:</strong> {{ $service->flightRequest->departure_at->toDayDateTimeString() }}</li>
    @if ($service->deadline)
